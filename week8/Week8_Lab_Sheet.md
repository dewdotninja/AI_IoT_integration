...
**01211271 Industrial AI and IoT** · Week 8 · Electromechanical Manufacturing Engineering

**Time:** 180 minutes (the second half of today's session)
**Files:** `Week8_From_Sensor_Data_to_a_Dataset.ipynb`, `wokwi/`
...
- **Week 9** trains classifiers on the CSV you export today.
- **Week 11** compiles one of those classifiers back onto the device that produced
  the features.
- **Weeks 12–13** publish these same feature vectors to NETPIE.

If your feature code is wrong today, everything after it is wrong and you will not
find out until Week 11.

---

## Part A — On the laptop (60 min)

Work through `Week8_From_Sensor_Data_to_a_Dataset.ipynb` from the top. Run every
...
**A3.** Run sections 6–8 and confirm `week8_dataset.csv` is written.
